...
const sources = {
  class11: {botany:'BOTANY_I_SYLLABUS.pdf',zoology:'ZOOLOGY_-I_SYLLABUS.pdf',physics:'PHYSICS_I_SYLLABUS.pdf',chemistry:'CHEMISTRY_I_SYLLABUS.pdf'},
